import type { Attributes, Element, Root } from 'xast'
 ...
 *
 * @param element
 *   The element to attach namespace information onto.
 * @param parentNamespaces
 *   The namespaces that are inherited from the parent element.
 * @returns
 *   A copy of the node, but with namespace data attached.
 */
 ...
 *
 * @param tree
 *   The document tree to attach namespace data to. If a xast root is passed, its element child will
 *   be used.
 * @returns
